...
/**
 * <p>
 * Cette classe crée et configure un panneau de bienvenue qui sert comme
 * écran d'accueil et qui introduit l'application à l'usager.
 * </p>
 *
...
public class VuePanneauBienvenue extends JPanel {
     ...
     * de bienvenue. Cela inclut un bref texte d'introduction et d'explication
